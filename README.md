...
(Tambahkan screenshot dari Cisco Packet Tracer ke repo dan beri nama screenshot_topologi.png)
...
Tugas1_Jarkom_<nama>_<NRP>.xlsx – berisi perhitungan VLSM, CIDR, Supernetting.

Tugas1_Jarkom_<nama>_<NRP>.pkt – file Cisco Packet Tracer dengan konfigurasi lengkap.

readme.txt – berisi link GitHub ini.
